...
output_file = os.path.join(output_dir, "fichiers_elec_nettoyes.csv")
...
fichiers_elec = [
    "DATA\\elec\\Donnees-de-consommation-et-de-points-de-livraison-denergie-a-la-maille-IRIS-electricite-.2018.csv",
    "DATA\\elec\\Donnees-de-consommation-et-de-points-de-livraison-denergie-a-la-maille-IRIS-electricite-.2019.csv",
    "DATA\\elec\\Donnees-de-consommation-et-de-points-de-livraison-denergie-a-la-maille-IRIS-electricite-.2020.csv",
    "DATA\\elec\\Donnees-de-consommation-et-de-points-de-livraison-denergie-a-la-maille-IRIS-electricite-.2021.csv",
    "DATA\\elec\\Donnees-de-consommation-et-de-points-de-livraison-denergie-a-la-maille-IRIS-electricite-.2022.csv",
    "DATA\\elec\\Donnees-de-consommation-et-de-points-de-livraison-denergie-a-la-maille-IRIS-electricite-.2023.csv",
]
